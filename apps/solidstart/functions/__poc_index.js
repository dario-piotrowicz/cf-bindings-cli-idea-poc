var manifest = {
	...
	script: {
		type: "script",
		href: "/assets/_...404_-c8f44bfc.js"
	},
	assets: [
		{
			type: "script",
		...
		{
			type: "script",
			href: "/assets/entry-client-fab7bab4.js"
		},
		{
			type: "style",
			href: "/assets/entry-client-959a9424.css"
		}
	]
},
	"/": {
...
function Links() {
  ...
  useAssets(() => {
    ...
    const links = match.reduce((r, src) => {
      let el = src.type === "style" ? ssr(_tmpl$$2, ssrHydrationKey(), ssrAttribute("href", escape(src.href, true), false)) : src.type === "script" ? ssr(_tmpl$2, ssrHydrationKey(), ssrAttribute("href", escape(src.href, true), false)) : undefined;
      if (el) r[src.href] = el;
      return r;
    }, {});
...
function Home() {
  ...
  return ssr(_tmpl$, ssrHydrationKey(), escape(text()));
}
